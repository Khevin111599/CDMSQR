                                            ...
                                            if(!isset($_SESSION['staff']))
                                            {
                                                ...
                                                while($row = mysqli_fetch_array($squery))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <a target="_blank" href="generate.php?resident='.$row['residentid'].'&permit='.$row['businessName'].'&val='.base64_encode($row['businessName'].'|'.$row['residentname'].'|'.$row['dateRecorded']).'" onclick="location.generate.php();" class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Generate</a></td>
                                                        </tr>
                                                        ';
