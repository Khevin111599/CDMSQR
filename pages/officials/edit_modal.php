        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input name="txt_edit_captain" class="form-control input-sm" type="text" value="'.$row['captain'].'" />
                </div>
                <div class="form-group">
                    <label>Username: </label>
                    <input name="txt_edit_sterm" class="form-control input-sm" type="text" value="'.$row['username'].'" />
                </div>
                <div class="form-group">
                    <label>Password: </label>
                    <input name="txt_edit_eterm" class="form-control input-sm" type="text" value="'.$row['password'].'" />
                </div>
            </div>
        </div>
        </div>
